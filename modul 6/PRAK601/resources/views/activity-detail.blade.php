...
<div class="mx-auto w-full max-w-3xl">
    <div class="bg-white/85 backdrop-blur border border-white/60 shadow-2xl rounded-3xl p-8 md:p-10">
        ...
        <img
            class="mt-6 w-full aspect-square rounded-2xl object-cover"
        ...
        <div class="mt-6 grid gap-4 md:grid-cols-2">
            <div class="rounded-2xl bg-white p-4 border border-gray-100 shadow-sm">
                ...
                <p class="font-semibold text-gray-800">{{ $activity['date'] }}</p>
            </div>
            <div class="rounded-2xl bg-white p-4 border border-gray-100 shadow-sm">
        ...
        <div class="mt-6 rounded-2xl bg-white p-4 border border-gray-100 shadow-sm">
            <p class="text-xs uppercase tracking-widest text-gray-400">Kesan</p>
            ...
            <br>
            <p class="text-xs uppercase tracking-widest text-gray-400">Deskripsi</p>
